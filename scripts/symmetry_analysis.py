...
#dfile=open('tunisia_symmetry_processed.txt','r')
dfile=''
tot={}
devices=[]
"""
...
path_as_total={}
"""
def is_ipsymmetric(r1,r2,path_ip_symmetric={},path_ip_total={},path_as_symmetric={},path_as_total={}):
...
def is_assymmetric(r1,r2,path_ip_symmetric={},path_ip_total={},path_as_symmetric={},path_as_total={}):
...
as_symmetry=[]
"""
def analyse_data(ip_symmetry,as_symmetry,path_ip_symmetric={},path_ip_total={},path_as_symmetric={},path_as_total={}):
    for dev in devices:
        if dev in path_ip_symmetric and dev in path_ip_total:
...
def main(fn='',loc=''):
    ...
    for line in dfile.readlines():
        if line.startswith('Device id'):
            ...
            if direction==1:
                ...
                rt_cur=rt
                is_ipsymmetric(rt_prev,rt_cur,path_ip_symmetric,path_ip_total,path_as_symmetric,path_as_total)
                is_assymmetric(rt_prev,rt_cur,path_ip_symmetric,path_ip_total,path_as_symmetric,path_as_total)
    ...
    analyse_data(ip_symmetry,as_symmetry,path_ip_symmetric,path_ip_total,path_as_symmetric,path_as_total)
    #plot_symmetry()
    return ip_symmetry
