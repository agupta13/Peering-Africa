...
def findDiff(n1,n2,listSet,asName):
    print "find difference between the lists: "+n1+", "+n2
    #print set(listSet[n1])
    a1=set.intersection(set(listSet[n1]) & set(listSet[n2]))
    a2= set(listSet[n1]).difference(a1)
    #print a1
    #print a2
    for asn in list(a2):
        print ''+str(asn)+', '+asName[(n1,asn)]
...
def main():
    ...
    print overlaps
    #(n1,n2)=('jinx','za')
    #findDiff('jinx','za',listSet,asName)
    #findDiff('kixp','ke',listSet,asName)

    # list of ASes at JINX not in ZA list
    """
    n1='jinx'
    a1=set.intersection(set(listSet[n1]) & set(listSet['za']))
    a2= set(listSet[n1]).difference(a1)
    print a1
    print a2
    #print listSet.keys()
