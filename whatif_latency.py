...
def plot_cdf(r1,r2):
    ...
    pl.legend((p),rlabel,'lower right',prop={'size':24})
    pl.xlabel('RTT (ms)',fontsize=32)
    pl.ylabel('% Routes ',fontsize=32)
    ax.grid(True)
    ...
    for line in fopen.readlines():
        ...
        if line.startswith('hops'):
            ...
            if hop==mhop:
                ...
                if rtt>diff and diff>=200 and rtt<1000:
